...
SECRET_KEY = 'isercom-clinic-2025-super-secret-key-with-more-than-50-characters-and-unique-symbols!@#$%^&*()_+-=[]{}|;:,.<>?'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True  # Set to False in production

ALLOWED_HOSTS = ['127.0.0.1', 'localhost', '*.isercom.com']  # Add your domain in production
...
STATICFILES_DIRS = [
    ...
    BASE_DIR / 'frontend',  # Add frontend directory for serving static frontend files
]
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = "felixasante2005@gmail.com"  # Your Gmail address
EMAIL_HOST_PASSWORD = "oqpv sihg fjhn nyws"# Replace with Gmail App Password (not regular password)
